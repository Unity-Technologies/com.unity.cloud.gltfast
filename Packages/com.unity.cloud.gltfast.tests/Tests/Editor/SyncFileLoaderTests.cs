...
namespace GLTFast.Editor.Tests
{
    class SyncFileLoaderTests
    {
        ...
        public void MissingFile()
        {
            ...
            Assert.AreEqual(0, loader.NativeData.Length);
        }
        ...
        public void ReadsFile()
        {
            ...
            CollectionAssert.AreEqual(k_Content, loader.NativeData.ToArray());
        ...
        public void DataCopiesToManagedArray()
        {
            ...
            LogAssert.Expect(LogType.Error, new Regex("Managed byte array"));
